# Hivemind Worker A Loop

Use this prompt for the first development worker loop.
...
1. Worker A only picks issues with odd-numbered issue IDs.
...
3. Pick the smallest eligible open odd-numbered issue that is not already in flight.

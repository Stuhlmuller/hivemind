...
7. If subagent delegation is unavailable in this runtime, continue locally and note that limitation in the run result instead of pretending delegation happened.
